...
#SBATCH -o /gpfs/home/dyj09myu/scratch/Teaching/BED_overlap/Output_Messages/BED_overlap.out   # Output file
#SBATCH -e /gpfs/home/dyj09myu/scratch/Teaching/BED_overlap/Error_Messages/BED_overlap.err    # Error file
#SBATCH --mail-type=ALL                             # Send email on job start, end, and abort
#SBATCH --mail-user=dyj09myu@uea.ac.uk              # Email address

# Load bedtools module on HPC
module load bedtools

# Define the input BED files
file1="/gpfs/home/dyj09myu/scratch/Teaching/BED_overlap/DPure_indels_mask.bed"
file2="/gpfs/home/dyj09myu/scratch/Teaching/BED_overlap/LPure_indels_mask.bed"

# Define the output directory
output_dir="/gpfs/home/dyj09myu/scratch/Teaching/BED_overlap/output"
